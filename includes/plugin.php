...
final class Plugin {
	 ...
	 * @access private
	 * @static
	 * @var \Equity_Addon\Plugin The single instance of the class.
	 */
	...
	public function my_plugin_frontend_stylesheets() {
		...
		wp_register_style( 'slider-style', plugins_url( '/assets/css/slider-style.css', __FILE__ ) );
	...
	public function my_plugin_frontend_scripts() {
		...
		wp_register_script( 'slider-js', plugins_url( '/assets/js/slider.js', __FILE__ ), [ 'jquery' ], '', true );
	...
	public function custom_categories( $elements_manager ) {
		...
		$elements_manager->add_category(
			'galleryslider',
			[
				'title' => esc_html__( 'Gallery Slider', 'equity-addon' ),
				'icon' => 'fa fa-plug',
			]
		);
	...
	public function register_widgets( $widgets_manager ) {
		...
		$widgets_manager->register( new \Gallery_Slider_Addon\Gallery_Slider() );
